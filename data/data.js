...
// ── Nations ──────────────────────────────────────────────────
const NATIONS = {
  germany:    { id:'germany',    name:'Germany',            shortName:'GER', abbr:'DE',  icon:'../src/Pictures/Nations_Buttons/germany-symbol.jpg',    side:'axis',   color:'#18181b', accent:'#71717a', flag:'🇩🇪', startTreasury:30, startIncome:30, mainCapital:'Germany (Berlin)' },
  italy:      { id:'italy',      name:'Italy',              shortName:'ITA', abbr:'IT',  icon:'../src/Pictures/Nations_Buttons/italy-symbol.jpg',      side:'axis',   color:'#78350f', accent:'#d97706', flag:'🇮🇹', startTreasury:10, startIncome:10, mainCapital:'Southern Italy (Rome)' },
  japan:      { id:'japan',      name:'Japan',              shortName:'JAP', abbr:'JP',  icon:'../src/Pictures/Nations_Buttons/japan-symbol-axis-allies-sticker.jpg', side:'axis',   color:'#9a3412', accent:'#fb923c', flag:'🇯🇵', startTreasury:26, startIncome:26, mainCapital:'Japan (Tokyo)' },
  soviet:     { id:'soviet',     name:'Soviet Union',       shortName:'SOV', abbr:'SU',  icon:'../src/Pictures/Nations_Buttons/soviet-union-symbol.jpg',    side:'allies', color:'#7f1d1d', accent:'#f87171', flag:'🇷🇺', startTreasury:37, startIncome:37, mainCapital:'Russia (Moscow)' },
  usa:        { id:'usa',        name:'United States',      shortName:'USA', abbr:'US',  icon:'../src/Pictures/Nations_Buttons/usa-symbol.jpg',          side:'allies', color:'#14532d', accent:'#4ade80', flag:'🇺🇸', startTreasury:52, startIncome:52, mainCapital:'Eastern United States (Washington)' },
  uk_europe:  { id:'uk_europe',  name:'United Kingdom',     shortName:'UKE', abbr:'UK',  icon:'../src/Pictures/Nations_Buttons/uk-union-jack-symbol.jpg',side:'allies', color:'#713f12', accent:'#fbbf24', flag:'🇬🇧', startTreasury:28, startIncome:28, mainCapital:'United Kingdom (London)' },
  uk_pacific: { id:'uk_pacific', name:'UK Pacific',         shortName:'UKP', abbr:'UKP', icon:'../src/Pictures/Nations_Buttons/uk-symbol.jpg',         side:'allies', color:'#713f12', accent:'#fbbf24', flag:'🏴', startTreasury:17, startIncome:17, mainCapital:'India (Calcutta)' },
  anzac:      { id:'anzac',      name:'ANZAC',              shortName:'ANZ', abbr:'ANZ', icon:'../src/Pictures/Nations_Buttons/anzac-symbol.jpg',      side:'allies', color:'#374151', accent:'#9ca3af', flag:'🇦🇺', startTreasury:10, startIncome:10, mainCapital:'New South Wales (Sydney)' },
  china:      { id:'china',      name:'China',              shortName:'CHI', abbr:'CN',  icon:'../src/Pictures/Nations_Buttons/china-symbol.jpg',        side:'allies', color:'#166534', accent:'#bbf7d0', flag:'🇨🇳', startTreasury:12, startIncome:12, mainCapital:null },
  france:     { id:'france',     name:'France',             shortName:'FRA', abbr:'FR',  icon:'../src/Pictures/Nations_Buttons/france-symbol.jpg',       side:'allies', color:'#1e3a8a', accent:'#60a5fa', flag:'🇫🇷', startTreasury:19, startIncome:19, mainCapital:'France (Paris)' },
...
// ── Units ─────────────────────────────────────────────────────
const UNITS = [
  { id:'infantry',      name:'Infantry',                    type:'land',  cost:3,  attack:1, defense:2, move:1  },
  { id:'artillery',     name:'Artillery',                   type:'land',  cost:4,  attack:2, defense:2, move:1  },
...
const TERRITORIES = [
  ...
  { id:'vologda',             name:'Vologda',                              ipc:1,  continent:'Europe',         startController:'soviet',     isCapital:true,  isMainCapital:false },
  { id:'tambov',              name:'Tambov',                               ipc:1,  continent:'Europe',         startController:'soviet',     isCapital:false, isMainCapital:false },
  { id:'volgograd',           name:'Volgograd',                            ipc:2,  continent:'Europe',         startController:'soviet',     isCapital:false, isMainCapital:false },
  ...
  { id:'egypt',               name:'Egypt',                                ipc:2,  continent:'Africa',         startController:'uk_europe',  isCapital:false, isMainCapital:false },
  ...
  { id:'kiangsu',             name:'Kiangsu (Shanghai)',                   ipc:3,  continent:'Asia',           startController:'japan',      isCapital:false, isMainCapital:false },
  { id:'kiangsi',             name:'Kiangsi',                              ipc:1,  continent:'Asia',           startController:'japan',      isCapital:false, isMainCapital:false },
  { id:'kwangtung',           name:'Kwangtung (Hong Kong)',                ipc:3,  continent:'Asia',           startController:'uk_pacific', isCapital:false, isMainCapital:false },
  ...
  // ── Pacific / Australia ───────────────────────────────────
  { id:'philippines',         name:'Philippines',                          ipc:2,  continent:'Pacific',        startController:'usa',        isCapital:false, isMainCapital:false },
  ...
  { id:'hawaii',              name:'Hawaiian Islands',                     ipc:1,  continent:'Pacific',        startController:'usa',        isCapital:false, isMainCapital:false },
